...
| **AC23.06** | Élaborer des visualisations de données |
...
├── JavaScript     → Interactions et logique métier
├── Leaflet.js     → Cartographie interactive (ou Google Maps)
├── Chart.js       → Graphiques et visualisations
└── Tailwind CSS   → Framework CSS (optionnel)
...
| JavaScript | API Fetch & Async/Await | ⭐⭐⭐⭐ |
| Cartographie | Leaflet.js / Google Maps | ⭐⭐⭐⭐ |
| Data Viz | Chart.js & graphiques | ⭐⭐⭐ |
...
├── data/
│   └── cinemas.json       # Jeu de données
├── assets/
│   └── logos/             # Logos université
...
- [x] Logo de l'université IUT/Université
...
[![GitHub](https://img.shields.io/badge/GitHub-DEV95200-181717?style=flat&logo=github)](https://github.com/DEV95200)
